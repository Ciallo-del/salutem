...
public class ProductPropertyItemServiceImpl extends
  ...
  @OpLog(type = BaseDataOpLogType.class, name = "新增药品属性值，ID：{}, 编号：{}", params = {"#id",
      "#code"})
  ...
  @OpLog(type = BaseDataOpLogType.class, name = "修改药品属性值，ID：{}, 编号：{}", params = {"#id",
      "#code"})
  @Transactional(rollbackFor = Exception.class)
  @Override
  ...
  @Transactional(rollbackFor = Exception.class)
  @OpLog(type = BaseDataOpLogType.class, name = "删除药品属性值，ID：{}", params = "#id")
  @Override
